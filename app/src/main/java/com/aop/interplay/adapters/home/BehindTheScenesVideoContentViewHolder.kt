...
import com.aop.interplay.databinding.VideoViewBehindTheScenesItemBinding
...
class BehindTheScenesVideoContentViewHolder(
    binding: VideoViewBehindTheScenesItemBinding, videoInteractionListener: VideoInteractionListener
    ...
    override fun bind(dataModel: HomePost, position: Int) {
        ...
        with(binding as VideoViewBehindTheScenesItemBinding) {
            ...
            Glide.with(root.context).load(R.drawable.badge_bts_default).into(videoInfoLayout.ivChallengeType)
